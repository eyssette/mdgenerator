...
const editorElement = document.querySelector("#result");
...
const highlightCode = (editor) => {
	...
	code = code.replace(
		/(card:|z1:|z2:|z3:|z4:|back:|backImage:|style:|maths:|theme:|rectoVerso:|verso:|nombreZones:)/g,
...
const jar = CodeJar(editorElement, highlightCode, options);
window.jar = jar;